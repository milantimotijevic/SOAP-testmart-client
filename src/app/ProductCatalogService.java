 ...
 * 
 */
@WebServiceClient(name = "ProductCatalogService", targetNamespace = "http://app/", wsdlLocation = "http://nlsxx15-t460:8080/app/ProductCatalogService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PRODUCTCATALOGSERVICE_QNAME = new QName("http://app/", "ProductCatalogService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://nlsxx15-t460:8080/app/ProductCatalogService?wsdl");
    ...
    public ProductCatalog getProductCatalogPort() {
        return super.getPort(new QName("http://app/", "ProductCatalogPort"), ProductCatalog.class);
    }
    ...
    public ProductCatalog getProductCatalogPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://app/", "ProductCatalogPort"), ProductCatalog.class, features);
    }
